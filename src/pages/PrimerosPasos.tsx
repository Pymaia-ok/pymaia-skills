  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="pt-14">
          ...
          <motion.div {...fadeUp} className="p-6 rounded-2xl bg-secondary border border-border">
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              {[
                ...
                { icon: Plug, label: isEs ? "Skills, Conectores y Plugins" : "Skills, Connectors & Plugicps" },
        ...
        {/* ─── Section 4: Ecosistema de extensiplugin�plugin      <section id="mcps" className="max-w-4xl mx-auto px-6 pb-20 scroll-mt-24">
          <motion.div {...fadeUp}>
