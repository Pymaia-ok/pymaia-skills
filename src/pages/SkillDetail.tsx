            ...
            <div className="space-y-6 lg:sticky lg:top-20 lg:self-start">
              ...
              <div className="p-5 rounded-2xl border border-border bg-card space-y-4">
                <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                  <TrustBadge trustScore={(skill as any).trust_score || 0} securityStatus={(skill as any).security_status} scanResult={(skill as any).security_scan_result} showWarnings itemType="skill" createdAt={skill.created_at} isOfficial={false} creatorId={skill.creator_id} />
                ...
                <div className="border-t border-border pt-3 flex flex-wrap items-center gap-2">
                  ...
                  <ShareButton
                    url={(() => {
                      ...
                      return (skill as any).is_public === false && (skill as any).share_token ? `${base}?token=${(skill as any).share_token}` : base;
                    })()}
                    title={displayName}
                    description={tagline}
                  />
