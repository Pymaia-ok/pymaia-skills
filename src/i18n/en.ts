export default {
  ...
  landing: {
    ...
    heroChatUser1: "I need to prepare a competitive analysis for tomorrow",
    ...
    howStep1Label: "Install",
    howStep2Label: "Ask",
    howStep3Label: "Done",
    howstep1Title: "One command and go",
    howstep1Desc: "Install Pymaia Skills in Claude, Cursor or your favorite agent. 30 seconds.",
    howstep2Title: "Tell it what you need",
    ...
    ctaTitle: "One command.\nYour AI does the rest.",
    ctaSubtitle: "43,000+ professional solutions. Install Pymaia Skills, ask for what you need and solve without leaving your agent.",
