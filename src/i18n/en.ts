export default {
  ...
  landing: {
    ...
    heroChatUser1: "I need a competitive analysis for tomorrow's board meeting",
    heroChatAi1: "Analyzing 12 competitors… pricing, features and gaps detected. Executive report ready.",
    heroChatUser2: "Review this contract before signing",
    heroChatAi2: "14 clauses reviewed. 3 high risks identified with modification suggestions.",
    ...
    howstep1Title: "Tell us your goal",
    howstep1Desc: "Describe what you need — our AI recommends the best combination of Skills, MCPs and Plugins.",
    howstep2Title: "Verified & safe to activate",
    howstep2Desc: "Every tool is security-scanned with trust scores. Copy, paste and your assistant is ready.",
    ...
    whyCatalogTitle: "Unified catalog",
    whyCatalogDesc: "Skills, MCP Servers and Plugins in one place. No more jumping between directories.",
    whyGoalTitle: "Goal-first search",
    whyGoalDesc: "Describe what you need, not what tool you're looking for. Our AI matches the right solution.",
    whySecurityTitle: "Security-first",
    whySecurityDesc: "Every tool is scanned, scored and monitored. Trust scores and advisories keep you safe.",
    ...
    creatorTitle: "Build your own solutions",
    creatorSubtitle: "Package your expert knowledge into reusable solutions. Publish for everyone or share privately.",
    creatorFeature1Title: "Conversational interview",
    creatorFeature1Desc: "AI guides you step by step to turn your expertise into a professional solution.",
    creatorFeature2Title: "Public or private",
    creatorFeature2Desc: "Publish for the community or share privately with whoever you choose.",
    ...
    wizardSubtitle: "Tell us what you need and we'll recommend the best solutions.",

    popularTitle: "Most popular solutions",
    popularSubtitle: "The most activated by professionals like you.",
  ...
  detail: {
    ...
    publishAsPlugin: "Publish as plugin",
  },

  errors: {
    somethingWrong: "Something went wrong",
    unexpectedError: "An unexpected error occurred. You can go back to the home page and try again.",
  ...
  mcp: {
    ...
    toolsSubtitle: "48 tools organized by 8 categories. Claude uses them automatically.",
    toolGroupDiscovery: "Discovery (15)",
    toolGroupArchitect: "AI Solutions Architect (8)",
    toolGroupGeneration: "Generation (2)",
    toolGroupIntelligence: "Intelligence (4)",
    toolGroupPlatform: "Platform & Community (5)",
    toolGroupSkills20: "Skills 2.0 — Creation & Management (6)",
    toolGroupLifecycle: "Lifecycle — Publish & Manage (5)",
    toolGroupQuality: "Quality & Testing (3)",
    tools: {
      ...
      getInstall: "Get the exact install command for a specific skill, connector, or plugin.",
      getConnectorDetails: "Get detailed information about a specific MCP connector by slug.",
      listPopularConnectors: "List the most popular MCP connectors sorted by GitHub stars.",
      getPluginDetails: "Get detailed information about a specific plugin by slug.",
      listPopularPlugins: "List the most popular plugins sorted by installations.",
      getDirectoryStats: "Get overall stats about the directory: total skills, categories, top rated, most installed.",
      ...
      personalizedFeed: "Get personalized skill recommendations based on your install history.",
      topCreators: "Get the top skill creators leaderboard ranked by approved skills and rating.",
      ...
      installBundle: "Get install commands for all skills in a pre-built bundle for a specific role.",
      getSkillContent: "Read/fork raw SKILL.md content from any skill in the catalog.",
      validateSkill: "Quality check a SKILL.md before publishing. Returns score without inserting.",
      mySkills: "List all skills owned by the authenticated user with status and eval history.",
      semanticSearch: "AI-powered vector similarity search for natural language queries.",
      ...
      publishSkill: "Publish a SKILL.md to the directory with visibility control, pricing, and automatic security scanning.",
      importSkill: "Import a SKILL.md created by any AI agent into the catalog for sharing.",
      updateSkill: "Update a skill you own with new content, changelog, and semantic versioning.",
      unpublishSkill: "Remove a skill from the public directory (soft delete). Owner only.",
      reportSkill: "Report a skill for security, quality, or policy issues.",
      scanSkill: "Trigger a security scan for a SKILL.md before publishing.",
      runSkillEvals: "Run automated evaluation tests (5 cases) against a SKILL.md before publishing.",
      getSkillAnalytics: "Get analytics for your skills: installs, ratings, trends, and eval results.",
    },
  ...
  courses: {
    ...
    sectionSubtitle: "Interactive courses to master Claude tailored to your profession. Zero to expert.",
    pageSubtitle: "Learn to use Claude from zero to expert with courses designed for your professional role.",
    ...
    alreadyCompleted: "You already completed this module",
    previous: "Previous",
    next: "Next",
